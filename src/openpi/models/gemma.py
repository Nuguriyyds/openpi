...
class RMSNorm(nn.Module):
    ...
    def __call__(self, x, cond):
        ...
        # adaptive RMSNorm.  Pi0.5 usually passes a batch-level condition
        # (B, D), while training-time RTC needs token-wise flow timesteps
        # (B, T, D).  Accept both without changing the learned projection.
